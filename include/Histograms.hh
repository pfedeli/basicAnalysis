...
private:
    ...
    TH2F* hSD0_ = new TH2F("hSD0", "SD0", 100, 0, 10, 100, 0, 10);
    ...
    TH1F *hhTheta_ = new TH1F("hhTheta", "Orizontal theta in", 200, -10, 10);
    TH1F *hvTheta_ = new TH1F("hvTheta", "Vertical thata in", 200, -10, 10);
    TH1F *hhthetadiff_ = new TH1F("hhthetadiff", "horizontal deflection", 100, -10, 10);
    TH1F *hvthetadiff_ = new TH1F("hvthetadiff", "vertical deflection", 100, -10, 10);
    TH1F *hhthetaout_ = new TH1F("hhthetaout", "horizontal theta out", 200, -10, 10);
    TH1F *hvthetaout_ = new TH1F("hvthetaout", "vertical theta out", 200, -10, 10);
